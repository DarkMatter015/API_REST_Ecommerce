...
import br.edu.utfpr.pb.ecommerce.server_ecommerce.security.dto.AuthenticationResponse;
    ...
    protected void successfulAuthentication(HttpServletRequest request,
        ...
        response.getWriter().write(
                new ObjectMapper().writeValueAsString(
                        new AuthenticationResponse(token, new SecurityUserResponseDTO(user))
                )
        );
    }
